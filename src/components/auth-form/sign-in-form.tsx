...
import { Button, Card, CardBody, Typography, Input, Spinner } from '@material-tailwind/react';
import NotificationForm from './notification-form';

import userService from '../../services/user-service';
import { selectAuthModal, setAuthModalOpen } from '../../redux/features/auth-modal-slice';
...
const SignInForm: React.FC<SignInFormProps> = ({ switchAuthState, authUser }) => {
    ...
    return (
        <Card className="mx-auto w-full max-w-[48rem]">
            <CardBody className="flex gap-0 md:gap-8">
                <img src="auth-sign-in.svg" alt="auth" className="w-0 md:w-3/6 object-cover" />
                <div className="w-full md:w-3/6">
                    ...
                    {successMessage && <NotificationForm type="success" message={successMessage} />}
                    {/* Form success message end */}

                    {/* Form error message start */}
                    {errorMessage && <NotificationForm type="error" message={errorMessage} />}
                    ...
                    <form onSubmit={signInForm.handleSubmit} className="w-full space-y-4">
                        ...
                        <Button variant="outlined" fullWidth>
                            <Link to={oauthURL} className="flex justify-center items-center gap-2">
                                <img
                                    className="w-4 h-4"
