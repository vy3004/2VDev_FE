...
const Tags = () => {
  ...
  return (
    <div className="space-y-4">
      <PageDescription
        title={t("post.Tags")}
        desc={t("post.See information about all tags")}
      />
      ...
      {isLoading ? (
            ...
            >
              <div className="flex gap-2">
                ...
                <div className="text-left">
                  <Typography className="font-bold lowercase">
                    {name}
                  </Typography>
                  <Typography className="text-sm">
                    {count}{" "}
                    {t(`post.${count === 1 ? "question" : "questions"}`)}
                  </Typography>
                </div>
              </div>
            </Button>
        ...
        <NotFoundAlert message={t("post.No tags found")} type="error" />
      )}
    </div>
  );
};
